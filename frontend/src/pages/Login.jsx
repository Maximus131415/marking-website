...
// Единая ссылка на бэкенд из переменной окружения
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Сохраняем данные для доступа в других частях приложения
        localStorage.setItem('token', data.access_token);
        localStorage.setItem('role', data.role);
        
        // Плавный переход в личный кабинет
        navigate('/dashboard'); 
      } else {
